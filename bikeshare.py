...
def get_filters():
    ...
    months = list(map(str.lower, ['January', 'February', 'March', 'April', 'May', 'June', 'all']))
    while True:
    ...
    days = list(map(str.lower, ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday', 'all']))
    while True:
...
def load_data(city, month, day):
    ...
    if month != 'all':
        months = list(map(str.lower, ['January', 'February', 'March', 'April', 'May', 'June']))
